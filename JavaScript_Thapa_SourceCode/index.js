...
// var iAmAlam = null;
// console.log(iAmAlam);
// console.log(typeof(iAmAlam))//object
...
/**** Section 5 Expressions And Operators in JavaScript   ****/
// var x = 5;
// var y = 5;
...
// function sum(a,b){//a, b yaha parameter ha
//   var total = a+b;
//   console.log(total);
// }

// sum();
// sum(20,30);//20, 30 yaha arguments ha
// sum(50,50);
// sum(5,6)
...
//     console.log('outer ' + myFirstName);
//   }
// console.log('innerOuter ' + myLastName);//block ke bahar let use nhi kar sakte ha
// }
// biodata();
...
//for in elements index print
// for(let elements in myFriends){
//   console.log(elements);
// }

//for of print elements
...
//  console.log(arr2);
//
// let arr2 = arr.map((currElm) => currElm*2).filter((currElm)=>currElm>10);
// console.log(arr2)
...
//
// let arr = [2, 3, 4, 6, 8]
// let newarr = arr.map((curele)=>curele*2).filter((curele) =>curele>10).reduce((accumulator, curele)=>{
...
// console.log( txt.split(" "));          // Split on spaces as it is
...
// // we cannot avoid month secttion
